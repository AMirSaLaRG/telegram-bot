...
class RelationshipHandler:
    ...
    async def liking_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE, target_id: int):
        user_id = update.effective_user.id
        self.rel_db.like(user_id, target_id)

    async def add_friend_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE, target_id: int):
        query = update.callback_query
    ...
    async def block_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE, target_id: int):
        user_id = update.effective_user.id
        self.rel_db.block(user_id, target_id)


    async def report_handler(self, update: Update, context: ContextTypes.DEFAULT_TYPE, target_id: int):
        user_id = update.effective_user.id
    ...
    async def show_ppl(self,query, context, the_users):
        ...
        await self.show_case.show_selected_users(query, context, selected_users=targets_users)